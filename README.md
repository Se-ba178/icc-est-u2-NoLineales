...
### Practica BFS
Fecha : 13/07/2026
## Clase del BFSPathFinder 

Este código implementa el algoritmo BFS (Búsqueda en Anchura), diseñado para encontrar el camino más corto entre un nodo inicial y uno final en un grafo no ponderado. Utiliza una cola para explorar los nodos nivel por nivel, marcando los visitados para evitar ciclos y registrando los nodos "padre" para reconstruir el camino exacto desde el origen hasta el destino una vez hallado.
